...
As of <Tooltip tip="November 16th, 2023">taday</Tooltip> Segment doesn’t have a native Novu Destination integration **yet** .
...
<Tip>
If you you need an example of Novu destination function, you can find it in [here](https://github.com/iampearceman/segment-novu-destination-scripts).
...
3. Your Novu API Key.
4. Novu's API Endpoint: https://api.novu.co/v1/events/trigger
